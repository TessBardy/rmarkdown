...
author: "Jane Doe^[Department of science, University of Random. E-mail:<jane.does@random.edu>. Website: <http://www.janedoe.com>]"
date: "4 March 2020"
output: 
  pdf_document:
     toc: false
subtitle: A mock paper for an R markdown 
bibliography: references.bib
csl: health-economics.csl
header-includes:
...
#here, within the r chunk we can introduce the usual comment sections 
knitr::opts_chunk$set(echo=FALSE, message=FALSE )
library(dplyr)
library(ggplot2)
library(stargazer)
df_raw <- read.csv("C:/rmd_workshop-master/rmd_workshop-master/data/journals.csv")
```
```{r, data, echo=FALSE}
df <- df_raw %>%
...
|Delagado and Perry  |2010                | Descriptive        |Journal of Route    |
|Gilbert             |2019                | Predictive         | Journal of ground  |
+--------------------+--------------------+--------------------+--------------------+

: Existing publications in journals \label{table_author}
